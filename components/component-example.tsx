  ...
  return (
    <Example title="Card" className="items-center justify-center">
      <Card className="relative w-full max-w-sm overflow-hidden pt-0">
        ...
        <img
          src="https://images.unsplash.com/photo-1https://hdceo9s7rn.ufs.sh/f/omhVEzh0nq06FL9kCkiesR8KQJPMY5cu1mTIqpr3k2gGVvOL604076850742-4c7221f3101b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
